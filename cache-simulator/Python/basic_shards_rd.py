...
class Basic_shards_rd():
    def __init__(self, sample_rate):
        ...
        self.rd_list = defaultdict(list)  # mattson_rd algorithm
        self.rd_tree = AVLTree()  # balancetree_rd algorithm
        self.rd_hash = defaultdict(defaultdict)  # balancetree_rd algorithm
        self.rd_size_lookup = defaultdict(lambda: 0)  # mattson_rd algorithm
